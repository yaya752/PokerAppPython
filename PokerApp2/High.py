...
def high_hand_odd(occur,street,list_numplayers):
    ...
    odd_high_card = 0
    hc_zero = 0
    return [['Royal Flush',int(round(odd_royal_flush,2)*100),rf_zero],['Straight Flush',int(round(odd_straight_flush,2)*100),sf_zero],['Four of Kind',int(round(odd_four_of_Kind,2)*100),fok_zero],['Full House',int(round(odd_full_house,2)*100),fh_zero],['Flush',int(round(odd_flush,2)*100),f_zero],['Straight',int(round(odd_straight,2)*100),s_zero],['Three of Kind',int(round(odd_three_of_kind,2)*100),tok_zero],['Two Pairs',int(round(odd_two_pair,2)*100),tp_zero],["Pair",int(round(odd_pair,2)*100),p_zero],['High Card',int(round(odd_high_card,2)*100),hc_zero]]
